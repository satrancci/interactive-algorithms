...
const App = (props) => {
  ...
  return (
    <div id="app" style = {{boxSizing: "border-box", backgroundColor: "#F4F4F4"}}>
      ...
      {props.state.algorithm && <Minimizer up={minimizerUp} onToggle={onMinimizerToggle}/>}
      {props.state.algorithm && <InputDivider callback={onDividerSizeUpdate} resize={resize} displayBlock={minimizerUp}/>}
